import { G15EntryPoint } from './game-15-reconstruction/G15EntryPoint';
// import { Utils.prntUtil } from './game-15-reconstruction/utils/Utils.prntUtil';
...
export function setupCounter(element: HTMLElement) {
  ...
  document.getElementById('decreaseByTwo')?.addEventListener('click', () => G15EntryPoint.main());
...
// Utils.prntUtil.testPrint();
// await G15EntryPoint.main();
